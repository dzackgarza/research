...
- **Source axis** — AST audit of the SageMath 10.9 distribution (pinned commit [`686dc1a`](https://github.com/sagemath/sage/commit/686dc1a8d420c2e0aabadd4f602d9a0aa4690c50), dist SHA-256 recorded in the artifacts).
  Raw data and the deterministic generator are tracked in this wiki repository under `sage-source-audit-10.9/` ([categories](https://raw.githubusercontent.com/wiki/dzackgarza/research/sage-source-audit-10.9/sagemath-10.9-categories.csv), [axioms](https://raw.githubusercontent.com/wiki/dzackgarza/research/sage-source-audit-10.9/sagemath-10.9-axioms.csv), [constructions](https://raw.githubusercontent.com/wiki/dzackgarza/research/sage-source-audit-10.9/sagemath-10.9-functorial-constructions.csv), [feature declarations](https://raw.githubusercontent.com/wiki/dzackgarza/research/sage-source-audit-10.9/sagemath-10.9-category-feature-declarations.csv), [aliases](https://raw.githubusercontent.com/wiki/dzackgarza/research/sage-source-audit-10.9/sagemath-10.9-category-aliases.csv), [combined JSON](https://raw.githubusercontent.com/wiki/dzackgarza/research/sage-source-audit-10.9/sagemath-10.9-category-inventory.json), [generator](https://raw.githubusercontent.com/wiki/dzackgarza/research/sage-source-audit-10.9/build_sage_category_inventory.py)).

- **Runtime axis** — full class walk, registry dump, and instance enumeration of the running kernel (SageMath 10.10.beta0), scripts tracked under `sage-inventory-scripts/` ([dump_categories.py](https://raw.githubusercontent.com/wiki/dzackgarza/research/sage-inventory-scripts/dump_categories.py), [dump_classes.py](https://raw.githubusercontent.com/wiki/dzackgarza/research/sage-inventory-scripts/dump_classes.py), [dump_instances.py](https://raw.githubusercontent.com/wiki/dzackgarza/research/sage-inventory-scripts/dump_instances.py)).
