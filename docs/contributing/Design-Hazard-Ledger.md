...
**Guard.** Witness discipline ([mathematical-type convention](Mathematical-Language-Style-Guide.md#convention-mathematical-type): witness is a declared type; a presentation is never the home of the invariant it evaluates); layer quarantine ([mathematics-before-realization convention](Mathematical-Language-Style-Guide.md#convention-mathematics-before-realization)).
...
**Guard.** Name every section ([chosen-structure convention](Mathematical-Language-Style-Guide.md#convention-chosen-structure)); unnamed structure-reference is grep-detectable red.
...
**Guard.** Audience-relative admissibility ([standard-terms convention](Mathematical-Language-Style-Guide.md#sec-standard-terms)); the corpus boundary is which literature, not how well-known.
