...
Let $\varphi\colon A\to B$ be a homomorphism of commutative rings. Extension and
restriction of scalars define an adjunction
$$
...
$$
For an $A$-bilinear form $b\colon M\times M\to A$, its base change is the
$B$-bilinear form on $B\otimes_A M$ determined by
$$
