...
## 1. Derive first, admit declarations second
...
## 2. Introducing any name is the checkpoint
...
## 3. Author from the dictionary, not freehand
...
## 4. Route through the integration model
...
## 6. Corrections reset, they do not patch
...
## 7. Never defer a foundational defect
