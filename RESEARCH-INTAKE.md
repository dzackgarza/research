...
- [Research Intake](#research-intake)
  ...
  - [Leads](#leads)
  - [Intake report: https://github.com/taklab-org/CAP_finding_monodromy — 2026-09-15](#intake-report-httpsgithubcomtaklab-orgcapfindingmonodromy-2026-09-15)
  ...
  - [Desired capability: generatingfunctionology (Wilf Ch.1-2) — note 2026-09-15](#desired-capability-generatingfunctionology-wilf-ch1-2-note-2026-09-15)
  - [Desired capability: monodromy groups/representations + π1/H1 + CW + graded — note 2026-09-15](#desired-capability-monodromy-groupsrepresentations-π1h1-cw-graded-note-2026-09-15)
  - [Intake: https://github.com/lairez/periods — functionality — 2026-09-15](#intake-httpsgithubcomlairezperiods-functionality-2026-09-15)
  ...
  - [Desired capability: honest and operationalized Q_ℓ, étale cohomology, Galois cohomology as specialization — computable in some cases — note 2026-09-16](#desired-capability-honest-and-operationalized-qℓ-étale-cohomology-galois-cohomology-as-specialization-computable-in-some-cases-note-2026-09-16)
  ...
  - [Desired capability: zeta functions of varieties over F_q and Weil verification — note 2026-09-15](#desired-capability-zeta-functions-of-varieties-over-fq-and-weil-verification-note-2026-09-15)
  ...
  - [Intake: https://www-fourier.univ-grenoble-alpes.fr/~sergerar/Kenzo/kenzo-demo.html — functionality — 2026-09-15 — verbatim](#intake-httpswww-fourieruniv-grenoble-alpesfrsergerarkenzokenzo-demohtml-functionality-2026-09-15-verbatim)
  ...
  - [Intake: https://www-fourier.univ-grenoble-alpes.fr/~sergerar/Papers/Ana-JSC.pdf — fixtures + algorithms — 2026-09-15 — verbatim](#intake-httpswww-fourieruniv-grenoble-alpesfrsergerarpapersana-jscpdf-fixtures-algorithms-2026-09-15-verbatim)
  ...
  - [Desired capability: concrete geometric models for classifying spaces BG, EG→BG, simplicial objects in C, configuration spaces — note 2026-09-15](#desired-capability-concrete-geometric-models-for-classifying-spaces-bg-egbg-simplicial-objects-in-c-configuration-spaces-note-2026-09-15)
  ...
  - [Desired capability: composition series, filtrations, associated graded, semidirect, is_simple, Jordan-Hölder, Inn/Out, artinian/noetherian, subgroup poset — note 2026-09-15](#desired-capability-composition-series-filtrations-associated-graded-semidirect-issimple-jordan-hölder-innout-artiniannoetherian-subgroup-poset-note-2026-09-15)
  - [Desired capability: open-set categories, powersets, topologies, poset ↔ poset-category fluid interface — note 2026-09-15](#desired-capability-open-set-categories-powersets-topologies-poset-poset-category-fluid-interface-note-2026-09-15)
  - [Desired capability: short exact sequences `1→A→B→C→1` and fibrations `F→E→B` classified by Ext / twisting cocycle — note 2026-09-15](#desired-capability-short-exact-sequences-1abc1-and-fibrations-feb-classified-by-ext-twisting-cocycle-note-2026-09-15)
  - [Desired capability: Lie groups → Lie algebras, matrix groups as Lie groups, algebraic / Lie / group scheme interfaces, Ad/ad — note 2026-09-15](#desired-capability-lie-groups-lie-algebras-matrix-groups-as-lie-groups-algebraic-lie-group-scheme-interfaces-adad-note-2026-09-15)
  ...
  - [Desired capability: generalized weighted graphs, Coxeter/Dynkin/s.e. laced, bilinear ↔ graph — note 2026-09-16](#desired-capability-generalized-weighted-graphs-coxeterdynkinse-laced-bilinear-graph-note-2026-09-16)
  - [Desired capability: invariants/coinvariants under `G→O(M,b)`, folding, converse `G→Aut(D)→O(M,b)` — note 2026-09-16](#desired-capability-invariantscoinvariants-under-gomb-folding-converse-gautdomb-note-2026-09-16)
  ...
  - [Desired capability: content ideal `c_M(x)` of an element `x∈M` — note 2026-09-16](#desired-capability-content-ideal-cmx-of-an-element-xm-note-2026-09-16)
  ...
  - [Desired capability: matrix spaces over `R` as fibered category `Mat(R)` and module morphisms via matrices as honest functor — note 2026-09-16](#desired-capability-matrix-spaces-over-r-as-fibered-category-matr-and-module-morphisms-via-matrices-as-honest-functor-note-2026-09-16)
  ...
  - [Desired capability: `Top` and `Top_*`, `S = Spaces =` homotopy types `= ∞-groupoids` — note 2026-09-16](#desired-capability-top-and-top-s-spaces-homotopy-types-groupoids-note-2026-09-16)
  ...
  - [Desired capability: axiomatic subcategories of `Cat`, `show(C)`, limits/colimits, monads, `QX`, interchange — note 2026-09-16](#desired-capability-axiomatic-subcategories-of-cat-showc-limitscolimits-monads-qx-interchange-note-2026-09-16)
  ...
  - [Desired capability: Yoneda product on `Ext` operationalized — note 2026-09-16](#desired-capability-yoneda-product-on-ext-operationalized-note-2026-09-16)
  - [Desired capability: `MU` and `BP`, spectra, `E_n` and `A_n` ring spectra, free `E_n` algebras — note 2026-09-16](#desired-capability-mu-and-bp-spectra-en-and-an-ring-spectra-free-en-algebras-note-2026-09-16)
  ...
  - [Desired capability: framed manifolds, factorization homology, `(-)^{hG}` and `(-)_{hG}`, `MString` and `tmf` — note 2026-09-16](#desired-capability-framed-manifolds-factorization-homology-hg-and-hg-mstring-and-tmf-note-2026-09-16)
  ...
  - [Desired capability: Generalized Grassmannians $G/P$, Schubert calculus, and homogeneous bundles (Grassmannian.info) — intake 2026-09-19](#desired-capability-generalized-grassmannians-gp-schubert-calculus-and-homogeneous-bundles-grassmannianinfo-intake-2026-09-19)
  ...
  - [Desired capability: Euler operator $\theta = t \partial_t$ and standard formal operators on $R[[t]]$ — intake 2026-09-19](#desired-capability-euler-operator-theta-t-partialt-and-standard-formal-operators-on-rt-intake-2026-09-19)
  ...
  - [Desired capability: Associated torus $T(L) = L_\mathbb{R}/L$ and abelian varieties from $\mathbb{Z}$-lattices — intake 2026-09-19](#desired-capability-associated-torus-tl-lmathbbrl-and-abelian-varieties-from-mathbbz-lattices-intake-2026-09-19)
  ...
  - [Desired capability: Logarithmic differentials $\Omega_{R/S}(\log D)$, Stasheff associahedra, and Coxiter invariant integration — intake 2026-09-19](#desired-capability-logarithmic-differentials-omegarslog-d-stasheff-associahedra-and-coxiter-invariant-integration-intake-2026-09-19)
  - [Desired capability: Morse functions, gradient flows, trajectory moduli spaces, flow categories $\mathcal{C}_f$, and free loop spaces $LM$ — intake 2026-09-19](#desired-capability-morse-functions-gradient-flows-trajectory-moduli-spaces-flow-categories-mathcalcf-and-free-loop-spaces-lm-intake-2026-09-19)
  ...
  - [Desired capability: Polarized modules $(M, E)$ with spectral decomposition $M = M_- \oplus M_+$ from self-adjoint Fredholm operators — intake 2026-09-19](#desired-capability-polarized-modules-m-e-with-spectral-decomposition-m-m-oplus-m-from-self-adjoint-fredholm-operators-intake-2026-09-19)
  ...
  - [Intake: Ishige–Takayasu arXiv:2501.03792 — on-the-nose K3 PF monodromy — 2026-09-22](#intake-ishigetakayasu-arxiv250103792-on-the-nose-k3-pf-monodromy-2026-09-22)
...
**Source:** https://arxiv.org/abs/2501.03792 (arXiv:2501.03792v2, 2026-08-09) + https://ar5iv.org/html/2501.03792v2 — Toshimasa Ishige, Akitoshi Takayasu — *Computer-assisted proofs for finding the monodromy of Picard–Fuchs differential equations for a family of K3 toric hypersurfaces*. Code base for rendered results: Takayasu lab kv library 0.4.57 (`kv::allsol`, `kv::odelong_maffine`) and the companion CAP repo https://github.com/taklab-org/CAP_finding_monodromy (already intaken 2026-09-15 as generic validated LocSys transport). This intake operationalizes the *K3-specific on-the-nose instantiation* — exact $M_{\Sigma_i}\in\mathrm{GL}_4(\mathbb{Z})$ for the paper's family, as the model for any K3 (and CY) Picard–Fuchs population.

**Family and Picard–Fuchs ODE.** The paper studies the 2-parameter K3 toric hypersurface family whose periods satisfy the rank-4 Picard–Fuchs Pfaffian system $d\Phi = \Omega\Phi$, $\Omega = A(x,y)dx + B(x,y)dy$ with rational $A,B\in\mathrm{Mat}_4(\mathbb{C}(x,y))$ having simple poles along the singular divisor $\mathcal{S}\subset\mathbb{C}^2$ (Eqs. 1.8, 2.4). The Gauss–Manin connection $\nabla_{GM}$ on $H^2_{dR}(X/S)$ restricts to this $\Omega$ after trivialization; the PF operator is the cyclic-vector image in $D_S$. Generic line $\ell: 2(x-x_0)+(y-y_0)=0$ (2.5) is chosen through base point $(x_0,y_0)$ to reduce to $B = \ell\setminus\mathcal{S}$ with $\ell\cap\mathcal{S}=\{p_1,\dots,p_6\}$.

**Base point, singular locus, and loops.** Base point $(\lambda_0,\mu_0)$ with $\lambda_0=2^{-10}$, $\mu_0$ small, maps via $(x,y)=(\mu(\lambda-1/4)^{-2},\mu(\lambda-1/4)^{-3})$ to $(x_0,y_0)\approx(0.0157478,-0.0632382)$ (2.3). Intersection $\mathcal{S}\cap\ell$ is computed rigorously as 4 real roots $p_1<\dots<p_4$ and a complex-conjugate pair $p_5,\bar p_5=p_6$, enclosed as disjoint interval boxes via `kv::allsol` interval Newton on the system $\{xy(4x+y)[(36x+27y/2+1)^2-(1-12x)^3]=0,\;2(x-x_0)+(y-y_0)=0\}$ (Sec. 3.1). Loops $\Sigma_i$ encircling each $p_i$ from $p_0=(x_0,y_0)$ are prescribed explicitly as 3-segment piecewise smooth contours $x=c_x+r e^{\pm i\pi t},\; y=c_y-2r e^{\pm i\pi t}$ with centres/radii chosen to avoid other singularities (Sec. 2.3, 3.4). These $\Sigma_i$ generate $\pi_1(B,p_0)$.

**4-step CAP pipeline (paper Secs. 1.1, 2–3, Thm. 1.3, App. A).**

1. **Fundamental matrix at $b_0$.** Particular solutions $\varphi^k(\lambda,\mu)=\sum_{l,m\ge0} a_{lm}\lambda^l\mu^m\cdot(\log\lambda)^{(\cdot)}(\log\mu)^{(\cdot)}$ $(k=1..4)$ of Theorem 2.3 (Prop. 3.7) with $a_{lm}=(2l+4m)!/(l+m)!l!(m!)^3$ are evaluated at $(\lambda_0,\mu_0)$: truncated sums ($N_{\rm trunc}=41$) plus rigorous truncation bounds via majorants $\beta_N,\gamma_N,\delta_i(N)$ (Thms. 3.4–3.7, App. A) give interval enclosures of $\varphi^k,\varphi^k_x,\varphi^k_y,\varphi^k_{xy}$ and hence of $\Phi(b_0)\in\mathrm{GL}_4(\mathbb{C})$ (2.56). Operation: `fundamental_matrix(∇,b_0,N) → interval Mat_4` with certified $|\mathrm{error}|<\delta$.
...
3. **Rigorous analytic continuation.** Along each $\Sigma_i$ solve the variational ODE $d\Phi/dt = (\dot x(t)A(x(t),y(t))+\dot y(t)B(x(t),y(t)))\Phi(t)$, $\Phi(0)=\Phi(b_0)$, with $kv$ rigorous integrator `odelong_maffine`: Taylor order 15, interval / double-double / `interval<dd>` arithmetic, affine-arithmetic remainder to control wrapping effect, validated step-size control (Sec. 3, Rem. 1.2). Returns interval matrix $\Phi(1)\ni$ true analytic continuation $\tilde\Phi(b_0)$ after traversing $\Sigma_i$. Hard codes are $p=15$, `dd` precision; method is generic for any integrable $\Omega$ and any piecewise-smooth $\gamma$.

4. **Monodromy extraction and on-the-nose integer recovery.** $M_{\Sigma_i}=\Phi(b_0)^{-1}\Phi(1)\in\mathrm{GL}_4(\mathbb{C})$ as interval matrix (2.57). Unimodularity ($\det M_{\Sigma_i}=1$, from K3 lattice preservation) plus enclosure width $<0.5$ entrywise certifies the unique integer matrix inside — the on-the-nose $M_{\Sigma_i}\in\mathrm{GL}_4(\mathbb{Z})$ of Theorem 1.3 (Sec. 1.3). Since $M_{\Sigma_i}$ generate the monodromy group, this solves the monodromy problem up to conjugacy (fixed $\Phi(b_0)$ presentation). Remark 1.4 notes the matrices agree with the $K3$-lattice-theoretic values of [5] — the CAP route is independent of $K3$ lattice theory and therefore generalizes.

**What is K3-specific vs. what is general (verbatim hard-vs-soft split, cf. intake 2026-09-15).**
...
- *General method:* Input $(B=\mathbb{C}^k\setminus\mathcal{S},\; n,\; \Omega\in\mathrm{Mat}_n(\Omega^1(\log\mathcal{S}))$ integrable regular-singular, $b_0$, presentation of $\Phi(b_0)$ as series) → functor $\mathrm{LocSys}(\nabla):\pi_1(B,b_0)\to\mathrm{GL}_n$ → interval $M_\gamma$ with $M_\gamma\ni\rho([\gamma])$. Transport step (4) is fully general; step (1) is general up to replacing $a_{lm}$ growth analysis.
...
- **Cohomology and connection:** $H^2_{dR}(X/S)=R^2f_*\Omega^\bullet_{X/S}:\mathrm{QCoh}(S)$ with $\nabla_{GM}:H\to H\otimes\Omega^1_S$ in $\mathrm{FlatConn}^{rs}(S,\Delta)$; Pfaffian $\Omega$ is its matrix in a trivialization $H|_U\simeq\mathcal{O}_U^n$. PF ideal $\mathrm{Ann}_{D_S}(w)$ for $w(z)=\int_{\gamma_z}\Omega_z$ is the $D_S$-picture; monodromy lives on $\mathrm{Sol}(\nabla_{GM})\simeq R^2f^{an}_*\mathbb{C}\in\mathrm{LocSys}(U^{an})$ via Riemann–Hilbert.

- **Monodromy object:** $\rho=\mathrm{LocSys}(\nabla_{GM}):\pi_1(U^{an},b_0)\to\mathrm{GL}_n(\mathbb{Z})$ (or $\mathrm{O}(L)$ for polarized $K3$ lattice $L$), image $\mathrm{Mon}(\nabla_{GM})\le\mathrm{GL}_n(\mathbb{Z})$. Interface on $\nabla$ / $\mathrm{LocSys}$: `∇.monodromy_representation(b0) → Rep(π1)`, `∇.monodromy_matrices(generators)` → family $\{M_{\Sigma_i}:\mathrm{GL}_n(\mathbb{Z})\}$, `∇.monodromy_group() = ⟨M_{\Sigma_i}⟩`. Honest functors, not free functions `monodromy(...)`.

- **Validated transport adapter (private):** `ValidatedMonodromy(∇,b_0,γ,Φ(b_0))` using maintained interval libraries (kv, Arb, IntervalArithmetic.jl, CAPD) — $b_0$-enclosure via series majorant, rigorous ODE `odelong_maffine`-style Taylor+affine transport, interval $M_\gamma$. Certification to integer when $\rho$ is integral ($\mathrm{O}(L)$, $\mathrm{Sp}$, $\mathrm{SL}$) and width<0.5; otherwise returns tight interval. This adapts the Ishige–Takayasu code pattern without importing it: evaluator `Ω(x)` is the parameter, library choice is the backend, preamble owns the categories.

- **Generality beyond this PF equation:** any family where the PF/Pfaffian is known (Doran–Malmendier twists, Fano/K3 mirrors of arXiv:2403.07349, Batyrev–Borisov / Dolgachev–Nikulin polarizations, Lairez Griffiths–Dwork `Periods` adapter) and where $b_0$ admits explicit series/regular-singular expansion. Population grows with the PF operator population — no new monodromy formalism per family.

**Intended owners (refines the generic CAP row).**

- `categories/schemes/monodromy.py` — `MonodromyRepresentation`, `MonodromyGroup` on `FlatConn^{rs}` / `D^{rh}_S$`, `LocalSystem.monodromy()`.
...
- Not a free `compute_monodromy(A,B,loops)` — method on the connection/local-system: `∇.validated_monodromy(b0, loops)`.
