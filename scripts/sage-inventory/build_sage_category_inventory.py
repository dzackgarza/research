...
payload: dict[str, Any] = {
    "metadata": {
        ...
        "scope": (
            "Named category classes and category-valued wrapper constructors in src/sage/categories, including sage.categories.examples, plus "
            "source-declared axioms and functorial constructions."
        ),
        "counts": {
