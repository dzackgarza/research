#!/usr/bin/env python3
"""Add a web citation to writing/.assets/refs-web.bib by scraping its canonical source.
...
appends it to writing/.assets/refs-web.bib (deduped). Cite it as [@nlab:<slug>].
