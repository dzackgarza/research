...
| `program/coxeter-v2-categorical-foundations.md` | the Coxeter-v2 authority statement of the same program (landed 2026-08-20 with the second Coxeter wave): suspension $H \oplus M \oplus H$, bar resolutions by hyperbolic planes, an Ext spectral sequence, Dold-Kan, spectra, THH. It asserts $D(\mathrm{Bil}_R\text{-}\mathrm{Mod})$ with a $t$-structure whose heart is $\mathrm{Bil}_R\text{-}\mathrm{Mod}$ — the same non-additivity obstruction stated above, in its sharpest form, since a heart must be abelian |
