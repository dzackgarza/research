<!--
Origin: gitclones/Coxeter/tmp_restore/CONVENTIONS.md
...
- `/docs/api-planning/BILINEAR_FORMS_MATHEMATICAL_NOTES.md` - Comprehensive mathematical foundations
- `/docs/MATHEMATICAL_THEORY.md` - Core theoretical concepts
- `/docs/REQUIREMENTS.md` - Technical requirements and constraints
- `/docs/api-planning/` - Complete API design documentation
