<!--
Origin: gitclones/Coxeter/README.md
...
- [`research/archive/`](research/archive/) - Archived research and historical work
...
│   ├── README.md              # Research environment overview
...
│   └── archive/               # Archived research and historical work
├── implementation/            # ⚙️ Software development environment  
│   ├── README.md              # Implementation environment overview
│   ├── conventions/           # Mathematical definitions for agents
│   ├── planning/              # API specifications, algorithms, design
│   ├── tests/                 # Comprehensive test suite
│   ├── tools/                 # Development tools and utilities
│   └── src/                   # Source code implementation (placeholder)
