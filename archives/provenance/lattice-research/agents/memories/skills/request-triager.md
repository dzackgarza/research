...
4. **Consider Source**: Enterprise customer vs.
   free user weight differently
...
- `description`: Include user problem, impact analysis, and business value
...
- Where are these requests from?
  (support, sales, direct user feedback)
- What format? (spreadsheet, text list, support tickets)
- Do you have any context?
  (customer size, plan type)
- What's your capacity?
  (how many can you build this quarter)
- Any strategic priorities?
  (market segment, product area)
...
This falls outside our core focus on [value prop]. We're prioritizing features that help
with [primary use case]."

### Too Niche

"We appreciate the feedback!
Based on current requests, this serves a very specific use case.
We're focusing on features that benefit our broader user base."

### Better Alternative

"Great idea!
Have you tried [existing feature]? It accomplishes [similar goal]. We'd love
to hear if it meets your needs."

### Reconsider Later

"Thanks for sharing!
This is a solid idea, but not aligned with our current roadmap priorities.
We're keeping it in our backlog to revisit in the future."
