...
By [@DK25 Prop. 9.1.4], any terminal Coble surface of K3 type is
...
This is used in [@DK25 Prop. 9.1.5] to show that $K_S^2 \geq -10$, and
...
$n=1$.
Following [@DK25 Ex. 9.1.7], the image $W \da V(f_6) \da \eta(C)$ is an
