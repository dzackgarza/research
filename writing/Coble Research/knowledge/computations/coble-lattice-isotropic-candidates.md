...
The notebook cells that evaluate norm and divisibility on these vectors, in all three lattices, have their outputs **cleared**.
The vectors and the method survive; the resulting numbers do not.
...
Also recorded, from a separate OSCAR/Julia notebook, the $(r,a,\delta)$ invariants with printed discriminant forms: $U(2)\to(2,2,0)$, $U(2)\oplus E_8(2)\to(10,10,0)$, $U^3\oplus E_8(2)\to(14,8,0)$, $U\oplus U(2)\oplus E_8^{\oplus2}\to(20,2,0)$, $U\oplus U(2)\oplus E_8(2)\to(12,10,0)$, $E_8(2)\to(8,8,0)$. Here $\delta$ is computed as "some diagonal entry of the discriminant quadratic form is non-integral", citing AE22 Def. 2.3 for coparity.
