...
aliases:
  - Divisor model
  - Half-divisor model
  - Integral-affine divisor
created: 2026-05-08
---

> [!definition] Divisor Model
> A **divisor model** for a degeneration $\pi: {\mathcal{X}} \to C$ of K3 (or Enriques) surfaces is a degeneration of pairs $({\mathcal{X}}, {\mathcal{R}}) \to C$ where:
> 1. ${\mathcal{R}}$ is a Cartier divisor, effective on all fibers.
> 2. For $t \neq 0$, ${\mathcal{R}}_t$ is semiample.
> 3. ${\mathcal{R}}$ is disjoint from the singular strata of the central fiber ${\mathcal{X}}_0$.
> 
