...
> The integral-affine sphere $B(\lambda)$ is constructed by gluing two copies: $$ B(\lambda) = P(\lambda) \cup P(\lambda)^{\mathrm{op}} $$ This sphere is the dual complex $\Gamma({\mathcal{X}}_0)$ for the given monodromy.
> The equator connecting the two copies supports the **integral-affine polarization** $R_{\mathrm{IA}}$.
