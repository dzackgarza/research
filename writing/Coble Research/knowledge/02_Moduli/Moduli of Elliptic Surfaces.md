---
title: Moduli of Elliptic Surfaces
tags:
...
> [!remark] Moduli of Elliptic Surfaces ($F_{\mathrm{ell}}$) The moduli space $F_{\mathrm{ell}}$ parametrizes elliptic K3 surfaces with a chosen section (fixing $U_1 \subset L_{\mathrm{K3}}$). The period map is defined on $T_{\mathrm{ell}} \mathrel{\mathop:}= U_1^{\perp_{L_{\mathrm{K3}}}} \cong U^2 \oplus E_8^2$.
> 
