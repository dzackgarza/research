...
> Fix a basis of the [[K3 lattice]] $L_{\mathrm{K3}}$ corresponding to the decomposition $U^3 \oplus E_8^2$. We consider three morphisms on $L_{\mathrm{K3}}$, acting on vectors $(u_1, u_2, u_3, \alpha_1, \alpha_2)$ in this basis:
> 
> $$
> \begin{aligned}
