...
> [!lemma] Divisibility of Isotropic Vectors in Unimodular Lattices Let $L$ be a nondegenerate unimodular [[Lattice]], and let $v \in L$ be a primitive [[Isotropic Submodules and Vectors|isotropic vector]]. Then there exists $w \in L$ such that $(v, w) = 1$.
