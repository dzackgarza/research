---
title: Decomposability of 2-elementary lattices
tags:
...
> [!theorem] Decomposability of 2-elementary lattices
> If $L$ is an even [[2-Elementary Lattices|2-elementary lattice]], then $A_{L}$ can be written as a finite direct sum of discriminant forms $p, q, u$, and $v$ subject to the relations:
> $$
> \begin{aligned}
> u^2 & = v^2 \\
> p^4 & = q^4 \\
