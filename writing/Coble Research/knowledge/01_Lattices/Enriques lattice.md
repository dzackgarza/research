...
> [!definition] Enriques lattice The **Enriques lattice** is given by $$ L_{\mathrm{En}} \mathrel{\mathop:}= U \oplus E_8 \xrightarrow{\sim} \mathrm{II}_{1, 9} $$ where $U$ is the [[Hyperbolic plane]] and $E_8$ is the negative-definite $E_8$ [[Root lattice]].
> 
