...
> [!table] Coble lattice table For a Coble surface with $n$ boundary components, there are 10 irreducible families of K3 covers obtained by branching along the anti-bicanonical divisor.
