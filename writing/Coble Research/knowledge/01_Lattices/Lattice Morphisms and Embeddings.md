...
> A **morphism** between [[Lattice|lattices]] $(L_1, \beta_1)$ and $(L_2, \beta_2)$ is a morphism of $\mathbf{Z}$-modules $f: L_1 \to L_2$ that preserves the bilinear form: $\beta_1(v,w) = \beta_2(f(v), f(w))$ for all $v,w \in L_1$.
