...
> [!definition] Plus Construction for $D_n$ Define two vectors in $\mathbf{Q}^n$ by $v_+ = \frac{1}{2}(1,1,1,\ldots,1)$ and $v_- = \frac{1}{2}(-1,1,1,\ldots,1)$.
...
>   For $n=8$, $D_8^+ \xrightarrow{\sim} E_8$.
