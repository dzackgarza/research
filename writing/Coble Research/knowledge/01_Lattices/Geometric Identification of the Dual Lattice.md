---
title: Geometric Identification of the Dual Lattice
tags:
...
> [!theorem] Geometric Identification of the Dual Lattice For a nondegenerate integral [[Lattice]] $(L,\beta)$, the [[Dual Lattice|dual lattice]] can be identified with a sublattice of $L_{\mathbf{Q}} \mathrel{\mathop:}= L \otimes_{\mathbf{Z}} \mathbf{Q}$ via the bijection:
> $$
