...
> 
> Letting $(L_{\mathbf{R}}, \beta_{\mathbf{R}})$ be the extension of $L$ to $\mathbf{R}$, the diagonalization of the [[Gram Matrix|Gram matrix]] has $p$ positive terms and $q$ negative terms. We define:
