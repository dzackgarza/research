...
- **Lattice Invariants**: Use the **divisibility** $\text{div}_{T_{Co}}(e)$ to determine the unique $O(T_{Co})$-orbit and verify that the quotient lattice matches the Enriques $(10,8,0)_1$ (for 0-cusps) and $(8,6,0)_0$ (for 1-cusps) signatures.
