...
> [!theorem] Vinberg's Algorithm for Fundamental Chamber For an arithmetic reflection subgroup $\Gamma \subset \operatorname{O}(L)$, Vinberg's algorithm constructs a fundamental chamber $P \subset \mathbb{H}^n$:
