...
For Baily-Borel compactifications $\overline{F_\Gamma}^{\operatorname{BB}}$, **0-cusps** correspond to $\Gamma$-orbits of isotropic lines $I \subset L$, and **1-cusps** correspond to orbits of isotropic planes $J \subset L$. 1-cusps adjacent to a 0-cusp $[I]$ correspond to maximal parabolic subdiagrams of the Coxeter diagram for the reflection group of $M \mathrel{\mathop:}= I^\perp / I$.
