---
title: Root folding criterion for T_{dP}
tags:
...
> [!lemma] Root folding criterion
> Let $\Phi(T_{\operatorname{dP}})$ be the [[Root System and k-Roots|root system]] of $T_{\operatorname{dP}}$ and $I = -I_{\mathrm{En}}$ be the induced involution on $T_{\operatorname{dP}}$ whose fixed lattice is $T_{\mathrm{En}}$.
> 
> The [[Folded Root Systems|folded roots]] $\beta_{[v]} \in \Phi( T_{\operatorname{dP}}^{\langle I \rangle} )$ arise in exactly one of the following ways:
