...
> 
> A semifan relaxes the conditions of a fan by not requiring local finiteness or full support. This allows "partial" toroidalization at selected cusps while leaving others untouched or less refined.
> 
> Semitoroidal compactifications sit in a tower of proper birational morphisms:
> $$ \overline{F_\Gamma}^{\Sigma_\bullet} \longrightarrow \overline{F_\Gamma}^{\mathcal{F}_\bullet} \longrightarrow \overline{F_\Gamma}^{\operatorname{BB}} $$
> By [@AE22, Thm. 1], any normal compactification admitting such a tower is isomorphic to a semitoroidal compactification. They are critical for modeling KSBA boundaries where fans may be infinitely generated or accumulate.
