...
The generated [Sage category framework reference](sage/Sage-Category-Framework-Inventory.md) and [per-class inventory](../inventory/index.md) record the reference surface used by these comparisons.
