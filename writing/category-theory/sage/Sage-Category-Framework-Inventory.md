...
Related cases appear under [Known discrepancies in Sage 10.9](#sec-sage-discrepancies).
...
- **Source axis** — AST audit of the SageMath 10.9 distribution (pinned commit [`686dc1a`](https://github.com/sagemath/sage/commit/686dc1a8d420c2e0aabadd4f602d9a0aa4690c50), dist SHA-256 recorded in the artifacts).
  Raw data is tracked in the repository under [`data/sage-source-audit-10.9/`](../data/sage-source-audit-10.9/) ([categories](../data/sage-source-audit-10.9/sagemath-10.9-categories.csv), [axioms](../data/sage-source-audit-10.9/sagemath-10.9-axioms.csv), [constructions](../data/sage-source-audit-10.9/sagemath-10.9-functorial-constructions.csv), [feature declarations](../data/sage-source-audit-10.9/sagemath-10.9-category-feature-declarations.csv), [aliases](../data/sage-source-audit-10.9/sagemath-10.9-category-aliases.csv), [combined JSON](../data/sage-source-audit-10.9/sagemath-10.9-category-inventory.json)).
  The generator is [`scripts/sage-inventory/build_sage_category_inventory.py`](https://github.com/dzackgarza/research/blob/main/scripts/sage-inventory/build_sage_category_inventory.py); it reads an unpacked 10.9 distribution from a path fixed at the top of the file, so reproducing the audit needs that path set to a local copy.

- **Runtime axis** — full class walk, registry dump, and instance enumeration of the running kernel (SageMath 10.10.beta0), by [`dump_categories.py`](https://github.com/dzackgarza/research/blob/main/scripts/sage-inventory/dump_categories.py), [`dump_classes.py`](https://github.com/dzackgarza/research/blob/main/scripts/sage-inventory/dump_classes.py) and [`dump_instances.py`](https://github.com/dzackgarza/research/blob/main/scripts/sage-inventory/dump_instances.py) under `scripts/sage-inventory/`.
