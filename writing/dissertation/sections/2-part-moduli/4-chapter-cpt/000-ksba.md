...
<!-- see [Kollár, *Moduli of varieties of general type*, in: *Handbook of Moduli*, vol. II (2013), 131–157, arXiv:1008.0621], \cite[*Comp. Math.* 112 (1998), 147–182]{Alexeev}, [Kollár–Shepherd-Barron, *J. Algebraic Geom.* 1 (1992), 429–479]. -->

<!-- see (Kollár–Shepherd-Barron–Alexeev) compactification, as constructed in [Kollár–Shepherd-Barron, *J. Algebraic Geom.* 1 (1992), 429–479], \cite[*Comp. Math.* 112 (1998), 147–182]{Alexeev}, and [Kollár, *Moduli of varieties of general type*, Handbook of Moduli, vol. II, 2013 (arXiv:1008.0621)],  -->
...
A canonical example of a recognizable divisor comes from \cite{AE23}, who compactify the moduli spaces $F_{2d}$ of polarized K3 surfaces $(X, L)$ of degree $2d$.
...
where each $R_i$ is an irreducible rational curve and $n_d$ is given by the *Yau–Zaslow* formula, see e.g. \cite[Thm. 10.2]{AE23}.
...
This follows a similar line of work: for $F_2$, see \cite{AET23}, and for degree 2 elliptic K3 surfaces $\fell$, see \cite{ABE22}. These are $S$-polarized K3 surfaces for $S$ a 2-elementary lattice that primitively embeds in $\lkt$, of which there are exactly 75 by \cite{Nik79a}, and \cite[Thm. 9.10]{AE22} handles the remaining cases, including $\fttz$ corresponding to $S = U(2) = (2,2,0)_1$, using the fact that such surfaces carry a nonsymplectic involution $\iota$ whose ramification divisor $R_\iota$ is recognizable.
For $50$ of these cases, there is result similar to \Cref{main-theorem}: $\semitorcpt{F_S} \iso \ksbacpt{F_S}$ for a semifan associated to $R_\iota$ -- they are precisely the closures of irreducible components on which monodromy invariants $\lambda$ maintain a fixed *combinatorial type*, as defined in \cite{AE23a}.
...
From this, one can construct a *$d$-semistable Kulikov surface* such that $B(\lambda) \cong \Gamma(\mcx_0(\lambda) )$, which by \cite{Fri83a} smooths to K3 surface $\mcx_t \da \mcx_t(\lambda)$ and thus specifies a family $\mcx \da \mcx(\lambda)$.
