...
- \Cref{part-1} develops the combinatorial and lattice-theoretic foundations:
  ...
  - \Cref{chapter-2} establishes lattice-theoretic foundations, particularly Nikulin's theory of 2-elementary lattices, with applications to the invariant lattices $\lkt$, $\len$, $\ten$, and $\tdp$.
...
- \Cref{part-3} proves the main theorem and provides explicit computations:
  ...
  - \Cref{chapter-7} provides computational examples, constructing explicit dlt models for degenerations at each of the five 0-cusps of $\bd\bbcpt{\fent}$.
