...
We recall from [@AEGS25] the cusp diagram for $F_\En$, the moduli space of unpolarized Enriques surfaces, in \longref{fig:enriques-cusps} and the corresponding Coxeter diagrams in \longref{fig:enriques-coxeter-diagrams}.
...
The maximal parabolic subdiagrams for $(10, 10, 0)$ and $(10, 8, 0)$ are shown in \longref{fig:enriques-maximal-parabolics-10-10-0} and \longref{fig:enriques-maximal-parabolics-10-8-0} respectively.
