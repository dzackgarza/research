| Classical Type | Diagram | Affine Type | Diagram |
|---|---|---|---|
...
| $G_2$ | \dynkin[label, edge length=.75cm]G2 | $\tilde G_2$ | \dynkin[extended, label, edge length=.75cm]G2 |

: Classical and Affine Dynkin Diagrams {#tab:dynkin-diagrams-table}
