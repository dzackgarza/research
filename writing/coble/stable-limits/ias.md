...
The geometry of such a degeneration is depicted in @fig-moduli-degeneration:
...
$\cZ \da \cX/\ien$ and half-divisor models
$(\cZ, \cR_{\cZ}) \da (\cX, \cR)/\ien$ where $\cX \to (C, 0)$ and
