...
| --- | --- | --- | --- | --- | --- |
| P0-general-algebra-node-20260907 | P — general algebra node conversion: exact multiplication object, exact forgetful module, common multiplicative Hom, associative/unital split | ChatGPT research-track session; `/home/dzack/research` | write: `src/dzack_research/preamble/categories/algebras/algebras.py`; `src/dzack_research/preamble/categories/algebras/augmented_algebras.py`; `src/dzack_research/preamble/categories/algebras/free_algebras.py`; `src/dzack_research/preamble/categories/algebras/restricted_scalars.py`; `src/dzack_research/preamble/categories/algebras/graded_algebras.py`; `src/dzack_research/preamble/categories/algebras/sparse_free_algebras.py`; `src/dzack_research/preamble/categories/algebras/group_algebras.py`; `src/dzack_research/preamble/categories/algebras/comparison_maps.py`; `src/dzack_research/preamble/categories/abstract_categories/arrow_categories.py`; `src/dzack_research/preamble/categories/group/additive_homsets.py`; `src/dzack_research/preamble/categories/modules/pure/modules.py`; `src/dzack_research/preamble/categories/rings/ring_foundation.py`; `src/dzack_research/preamble/categories/functors/algebra_modules.py`; `src/dzack_research/preamble/categories/functors/algebra_scalar_change.py`; `src/dzack_research/preamble/categories/functions/lebesgue_graded.py`; `src/dzack_research/preamble/categories/schemes/ringed_spaces.py`; `src/dzack_research/preamble/categories/schemes/gluing.py`; `src/dzack_research/preamble/categories/schemes/schemes.py`; `src/dzack_research/preamble/categories/rings/commutative_algebra.py`; `src/dzack_research/preamble/categories/rings/number_fields.py`; `tests/algebras/test_general_algebra_structure.py` | `ef8dc146` (`a3017a8f` C/P prerequisite) | 2026-09-07T04:57:00Z |
...
| P | `66466ec7`: relative `xy=t`, special fiber, and scalar-preserving successive algebra quotients. `86ed6a99`: free/presented pushout spans. `289d4756`: number-field algebras retain their field engine and chosen primitive presentation. S consumed the represented algebra maps at `7b40b82a`, where affine Spec/FiberProduct maps now preserve owned endpoints. C/P's exact-carrier prerequisite is released at `a3017a8f`. The public ring-side quotient remains an explicit R prerequisite. | P0 is claimed: convert `Algebras(R)` to the arbitrary-multiplication node on the exact supplied module, route its common Hom through multiplication preservation, make algebra-to-module a genuine forgetful functor, and move legacy ring-backed families to the associative-unital composite. Lie/commutator conversion remains the next P release. | Claimed: `P0-general-algebra-node-20260907` from `f4d38efe` |
