...
| `CORE-lattice-isometry-category-boundary-20260911-0922` | category-boundaries / owned lattice isometry Hom group placement | Chat continuation 2026-09-11; `/home/dzack/research` | `src/dzack_research/preamble/categories/lattice_morphisms.py; tests/categories/test_lattice_isometry_owned_boundary.py` (write) | `HEAD` | 2026-09-11T09:22:00Z |
