...
| `ARCHIVE-morphism-matrix-helpers-20260909-1650` | archive reconciliation / morphism matrix row normal form and generated matrix group | Chat continuation 2026-09-09; `/home/dzack/research` | `src/dzack_research/preamble/categories/modules/module_morphisms/morphism_matrices.py; tests/modules/test_morphism_matrices_archive.py` (write) | `HEAD` | 2026-09-09T16:50:00Z |
