...
| C | `e472b85a` unifies construction hooks; `3e3e443d` repairs Hom inheritance; `3e9f7f3e`/`0a4de522` publish abstract obligations. `d88800f4`, `3610c3c9`, and `fcddb1eb` type generic category/Hom/parameter contracts. `92efc99e` types the direct set-map, indexed-family, selection, cardinal-Hom, and ordinal-Hom constructors. | Type the defining-data constructors nested on the surviving set/cardinal category implementation classes: ordinals/cardinals, ordered enumerations, powersets, function sets, fixed-cardinality subsets, products and coproducts. | Claimed: `C-set-data-signatures-20260907-1630`; broader C open |
