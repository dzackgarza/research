...
| `CORE-construction-common-category-20260911-1835` | category-boundaries / generic constructions use owned category join | Chat continuation 2026-09-11; `/home/dzack/research` | `src/dzack_research/preamble/categories/abstract_categories/constructions.py; tests/categories/test_construction_common_category_owned.py` (write) | `HEAD` | 2026-09-11T18:35:00Z |
