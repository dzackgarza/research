...
| --- | --- | --- | --- | --- | --- |
| A0-categorical-actions-20260907 | A0 — BG functors, natural transformations, and specialized action constructors, including actual R[G]-modules and their restricted R-presentations; complexity 95 | `/root/construction_contracts`; `/home/dzack/research` | write: `src/dzack_research/preamble/categories/group/g_objects.py`; `src/dzack_research/preamble/categories/group/g_sets.py`; `src/dzack_research/preamble/categories/group/groups.py`; `src/dzack_research/preamble/categories/group/classifying_categories.py`; `src/dzack_research/preamble/categories/abstract_categories/objects.py`; `src/dzack_research/preamble/categories/functors/group_actions.py`; `src/dzack_research/preamble/categories/modules/group_modules/group_modules.py`; `src/dzack_research/preamble/categories/modules/group_modules/group_lattices.py`; `src/dzack_research/preamble/categories/schemes/schemes.py`; `src/dzack_research/preamble/categories/schemes/quotients.py`; `src/dzack_research/preamble/categories/sets/set_categories.py`; `src/dzack_research/preamble/categories/modules/pure/modules.py`; `src/dzack_research/preamble/categories/algebras/group_algebras.py`; `src/dzack_research/preamble/categories/rings/ring_foundation.py`; `src/dzack_research/preamble/categories/functors/group_induction.py`; `src/dzack_research/preamble/categories/functors/group_scalar_change.py`; `src/dzack_research/preamble/categories/functors/scalar_change.py`; `tests/groups/test_categorical_group_actions.py` | `78494432`; exact defining actions and selected-base End enrichment; preserve nonidentity restriction/transport maps | 2026-09-07T03:08:55Z |
| M0-localization-action-20260907 | M0 — the localized fraction module's action into additive endomorphisms; complexity 55 | `/root/engine_review`; `/home/dzack/research` | write: `src/dzack_research/preamble/categories/modules/localizations.py`; `tests/modules/test_localized_module_vanishing.py` | `78494432`, native kernel `785749ee`; fraction algorithms remain at their existing owner; assertions unverified | 2026-09-07T03:08:55Z |
...
| C | `e472b85a` unifies ordinary-parent and fixed-Hom construction with nested refinement hooks and establishes the direct-action module consumer. `78494432` keeps endomorphism algebra enrichment over its selected commutative scalar ring. The noncommutative regular-module and forgetful-map assertions are committed, unverified. | A0 and M0 can consume this constructor contract. Category ordering, remaining defining-data conversions, discoverable contracts, and import boundaries retain their detailed requirements. | First construction consumer released: `78494432`; broader C remains open |
