...
| C | `e472b85a` unifies construction hooks; `3e3e443d` repairs Hom inheritance; `3e9f7f3e`/`0a4de522` publish abstract obligations. `d88800f4`, `3610c3c9`, and `fcddb1eb` type generic category/Hom/parameter contracts. `92efc99e` types direct set/cardinal constructors; `7310bad8` types the nested defining-data constructors for cardinal/ordinal, ordered-set, powerset, function-set, subset, product and coproduct objects. | Type the public set/cardinal construction functions that expose those owners: ordinals/cardinals, finite and ordered sets, fixed selections, powersets/exponentials/subsets, products/coproducts and their canonical maps. | Claimed: `C-set-public-signatures-20260907-1630`; broader C open |
