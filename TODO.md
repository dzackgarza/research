...
| `CORE-submonoid-category-boundary-20260911-0948` | category-boundaries / owned-only public submonoid ambient | Chat continuation 2026-09-11; `/home/dzack/research` | `src/dzack_research/preamble/categories/group/submonoids.py; tests/categories/test_submonoid_owned_boundary.py` (write) | `HEAD` | 2026-09-11T09:48:00Z |
