...
| N | `fbb2f2e3` adds SVG views on live `ConvexPolygons`; `79edb121` adds TikZ views on live `CoxeterDiagrams`; `b855835b` adds local Three.js HTML views for live 3D `ConvexPolytopes` by delegating to Sage's existing renderer. Assertions remain unverified under terminal-T policy. | 2D polygon SVG, 3D polytope Three.js and Coxeter/ADE TikZ views are complete. Only the general display-hook installation policy remains optional N work. | Released through 3D polytope view |
| N | `fbb2f2e3` adds SVG views on live `ConvexPolygons`; `79edb121` adds TikZ views on live `CoxeterDiagrams`; `b855835b` adds local Three.js HTML views for live 3D `ConvexPolytopes` by delegating to Sage's existing renderer. Assertions remain unverified under terminal-T policy. | 2D polygon SVG, 3D polytope Three.js and Coxeter/ADE TikZ views are complete. Only the general display-hook installation policy remains optional N work. | Released through 3D polytope view |
