...
| --- | --- | --- | --- | --- | --- |
| `ARCHIVE-predicate-subgroups-20260908-1846` | archive reconciliation / predicate subgroups | Chat continuation 2026-09-08; `/home/dzack/research` | `tests/groups/test_predicate_subgroups_archive.py` (write) | `HEAD` | 2026-09-08T18:46:00Z |
