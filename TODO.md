...
| C | `e472b85a` unifies construction hooks; `3e3e443d` repairs Hom inheritance; `3e9f7f3e`/`0a4de522` publish abstract obligations. `d88800f4`, `3610c3c9`, and `fcddb1eb` type generic category/Hom/parameter contracts. `92efc99e` and `7310bad8` type direct and nested set/cardinal construction data; `abe0fd22` types the corresponding public set/cardinal construction surface. | Type the public abstract categorical vocabulary: tensor/biproduct/product/coproduct and (co)equalizers, subobjects/cores/slices, diagram/cone/cocone builders, functor composition/natural transformations, underlying-set Hom and direct-sum decomposition. | Claimed: `C-abstract-public-signatures-20260907-1630`; broader C open |
