...
- [x] Thread all module constructors through the defining action.
...
- [x] Construct algebra objects through the general multiplication owner and its underlying module.
...
- [x] Make the generic group-action constructor produce the action datum in its supplied category.
...
- [x] Require chosen framings and presentations at their construction owners.
...
| V | `50b89584`, `278eb0f1`, `541e10d9`, and `16635e19` supply toric Weil/Cartier/Pic/Cl objects, comparison maps, valuations, Cartier line-bundle descent, and `O(1)`. `fa5da88e` equips smooth complete toric surface Picard groups with the exact integral intersection pairing. `8fccc0ed` adds free torus-invariant cycle groups and their exact rational-equivalence quotient to owned Chow groups. `4ffe5a1b`/`64956b24`, `86fc6172`, `a4642c13`, and `a21ffdc4` supply Cox rings, saturated section rings, homogeneous section identification, and characteristic-zero toric line-bundle cohomology. `35e8ffee`, `689c3057`, `020669bd`, and `69e478e5` supply complete linear systems, associated maps, exact coordinate-hyperplane restriction, jet evaluation, imposed multiplicity kernels, and their projective parameter spaces. `4dc538bd` supplies canonical/anticanonical bundles and `9350ab46` supplies toric Cartier-divisor and associated line-bundle pullback. Assertions remain unverified under terminal-T policy. | V1 meets its supported-scheme acceptance condition on the represented toric regime. Broader unchecked §11 generalizations (native product-projective descent, arbitrary closed-subscheme restriction, Bertini families, and general cycle functoriality) remain open requirements and were not marked complete here; H1 owns cycle-class/topological/cohomological comparison work. | Released: `9350ab46`; V1 complete |
...
| `H1-geometric-cech-cohomology-20260908-0313` | H1 / geometric Cech complexes and comparison maps | Chat continuation 2026-09-08; `/home/dzack/research` | `src/dzack_research/preamble/categories/schemes/geometric_cohomology.py; src/dzack_research/preamble/categories/schemes/toric/toric_schemes.py; src/dzack_research/preamble/categories/schemes/gluing.py; src/dzack_research/preamble/categories/schemes/__init__.py; src/dzack_research/preamble/all.py; tests/schemes/test_geometric_cohomology.py` (write) | `455cf0f9` | 2026-09-08T03:18:00Z |
...
| V | `0e70a242` supplies invertible sheaves on G distinguished affine covers, with transition units, local trivializations, sections, tensor powers and duals. V1 has `50b89584`, which attaches distinct toric Weil/Cartier and Class/Picard role objects and the explicit comparison square; `278eb0f1` exposes toric height-one valuations and principal divisors; `06530859` promotes divisor-polytope characters to actual global-section vector spaces; `83468971` computes ample Cartier intersections on smooth complete toric surfaces by normalized divisor-polytope volume and polarization; `38ae0f36` records the quotient construction on `A^2`, `P^2`, and `P^1 x P^1`; `547f9a18` introduces complete linear systems. `541e10d9` constructs finite-atlas invertible sheaves from Cartier transition characters, and `16635e19` supplies toric `O(1)`. `b727ed41` crosses Sage's exact integral toric Chow computation into owned graded Chow-group modules. `4ffe5a1b`/`64956b24` construct Cox rings with an isolated `Cl(X)` multigrading and homogeneous-degree lookup. `86fc6172` constructs section rings as saturated cone semigroup algebras, including nontrivial Veronese relations. `35e8ffee` constructs the basepoint-free associated map to the owned complete linear system. `a4642c13` identifies character sections linearly with their actual homogeneous Cox monomials. `a21ffdc4` exposes characteristic-zero toric line-bundle cohomology as owned vector spaces retaining `X,D,i`. Assertions in this continuation remain unverified under terminal-T policy. | Continue V1 with the still-general requirements: projective-product line bundles/intersections, restriction/evaluation maps to arbitrary closed subschemes, jets/imposed singularities, cycle representatives and functorial cycle operations. Do not mark the broad §11 checkboxes complete merely from the supported toric regime. | V1 checkpoint: `a21ffdc4`; claim active |
...
| H | `2845d8fe` supplies Tor/Ext objects from selected free resolutions; the existing syzygy tower supplies supported longer polynomial-presentation resolutions and cohomology/DGA owners already provide semantic cohomology and multiplication. `fc3d5363` lifts nonidentity module morphisms to actual free-resolution chain maps; `6eb82e35` induces covariant Tor and contravariant Ext maps in the resolved argument; `de434c23` exposes `tor`, `ext`, and exact projective-dimension answers in the projective/PID regimes. Assertions remain unverified under terminal-T policy. | H0 is complete. Geometric complexes, sheaf/singular cohomology, comparison maps, Hodge data, and higher direct images belong to H1 after G/D/V1. | Released: `de434c23`; H0 complete |
