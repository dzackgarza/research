...
| P | `66466ec7`: relative `xy=t`, special fiber, and scalar-preserving successive algebra quotients. `86ed6a99`: free/presented pushout spans. `289d4756`: number-field algebras retain their field engine and chosen primitive presentation. S consumed the represented algebra maps at `7b40b82a`, where affine Spec/FiberProduct maps now preserve owned endpoints. The public ring-side quotient remains an explicit R prerequisite. | The general algebra conversion next consumes C/P's exact underlying-module construction. Its multiplication, unit, Lie, Hom, and scalar-change requirements remain open; the cutoff handoff supplies the concrete next specimens and shared paths. Existing represented-family consumers retain their released scope. | Earlier relative presentations released: `289d4756`; general P conversion unclaimed |
