...
| `ARCHIVE-galois-arithmetic-20260909-0835` | archive reconciliation / Frobenius and subfield restriction arithmetic | Chat continuation 2026-09-09; `/home/dzack/research` | `tests/groups/test_absolute_galois_category_archive.py; tests/groups/test_galois_quotient_archive.py` (write) | `HEAD` | 2026-09-09T08:35:00Z |
