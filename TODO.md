...
- [ ] **`probe-and-exception-residue`**. **Needs:** `objects-through-categories-scheme-gluing`, `objects-through-categories-rings`, `objects-through-categories-modules`, `objects-through-categories-algebras`, `objects-through-categories-lattice-files`, `objects-through-categories-functions-sets-tensors`.
...
- [ ] **`inherited-operations-not-restated`**. **Needs:** `objects-through-categories-scheme-gluing`, `objects-through-categories-rings`, `objects-through-categories-modules`, `objects-through-categories-algebras`, `objects-through-categories-lattice-files`, `objects-through-categories-functions-sets-tensors`.
...
- [ ] **`membership-by-placement`**. **Needs:** `objects-through-categories-scheme-gluing`, `objects-through-categories-rings`, `objects-through-categories-modules`, `objects-through-categories-algebras`, `objects-through-categories-lattice-files`, `objects-through-categories-functions-sets-tensors`.
...
- [ ] **`owned-provenance-data`**. **Needs:** `objects-through-categories-scheme-gluing`, `objects-through-categories-rings`, `objects-through-categories-modules`, `objects-through-categories-algebras`, `objects-through-categories-lattice-files`, `objects-through-categories-functions-sets-tensors`.
