...
| `LATTICE-configuration-gap-lifting-20260908-0715` | lattice / libGAP permutation lifting | Chat continuation 2026-09-08; `/home/dzack/research` | `src/dzack_research/preamble/categories/vector_configurations.py; tests/lattices/test_configuration_gap_lifting.py` (write) | `80a07db7` | 2026-09-08T07:15:00Z |
