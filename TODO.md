...
| `ARCHIVE-fractional-ideal-submodule-20260909-2355` | archive reconciliation / fractional ideal ring and submodule semantics | Chat continuation 2026-09-09; `/home/dzack/research` | `src/dzack_research/preamble/categories/modules/fractional_ideals.py; tests/modules/test_fractional_ideal_archive_semantics.py` (write) | `HEAD` | 2026-09-09T23:55:00Z |
