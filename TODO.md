...
| `SHEAF-functors-finite-atlas-20260911-1755` | sheaf-functors / finite-atlas inverse image and module pullback | Chat continuation 2026-09-11; `/home/dzack/research` | `src/dzack_research/preamble/categories/schemes/gluing.py; tests/schemes/test_sheaf_functors.py` (write) | `49029964` | 2026-09-11T18:03:00Z |
...
| --- | --- | --- | --- | --- | --- |
| `ARCHIVE-free-forgetful-adjunction-20260911-1918` | archive reconciliation / free-forgetful algebra adjunction | Chat continuation 2026-09-11; `/home/dzack/research` | `src/dzack_research/preamble/categories/functors/free_algebras.py; src/dzack_research/preamble/categories/functors/free_forgetful.py; src/dzack_research/preamble/categories/algebras/group_algebras.py; computations/reports/archive_reconciliation_inventory.tsv` (write) | `HEAD` | 2026-09-11T19:18:00Z |
...
| `ARCHIVE-all-session-20260911-0950` | archive reconciliation / session all.py disposition | Chat continuation 2026-09-11; `/home/dzack/research` | `tests/foundations/test_session_namespace_archive.py; computations/reports/archive_reconciliation_inventory.tsv` (write) | `HEAD` | 2026-09-11T09:50:00Z |
