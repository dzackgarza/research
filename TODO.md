...
| --- | --- | --- | --- | --- | --- |
| `OWN-tensor-indices-20260908-1230` | collection ownership / tensor index families | Chat continuation 2026-09-08; `/home/dzack/research` | `src/dzack_research/preamble/tensors/tensor.py; tests/tensors/test_tensor_index_ownership.py` (write) | `c0e5466c` | 2026-09-08T12:30:00Z |
