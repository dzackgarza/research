...
| `LATTICE-polarized-equivariant-20260909-1115` | arithmetic / polarized equivariant lattice group | Chat continuation 2026-09-09; `/home/dzack/research` | `src/dzack_research/preamble/categories/lattice_centralizers.py; tests/lattices/test_polarized_equivariant_lattice.py` (write) | `HEAD` | 2026-09-09T11:15:00Z |
