...
- [ ] **`test-suite-mathematical-assertions`**. **Needs:** none.
  ...
  **Remaining:** the non-mathematical tests were purged on 2026-09-23 (1,600 of 2,620 test functions). 430 tests meet the standard; the 590 whose mathematical claim is kept but whose route goes through internals are listed, with their claims, in [`tests/REWRITE-QUEUE.md`](tests/REWRITE-QUEUE.md).
