...
| --- | --- | --- | --- | --- | --- |
| `LATTICE-subgroup-tits-incidence-20260908-1314` | arithmetic applications / finite-index Tits-building splitting with subgroup transporters | Chat continuation 2026-09-08; `/home/dzack/research` | `src/dzack_research/preamble/categories/isotropic_orbits.py; src/dzack_research/preamble/categories/orthogonal_quotients.py; src/dzack_research/preamble/categories/group/predicate_subgroups.py; tests/lattices/test_subgroup_tits_building_incidence.py` (write) | `4309d947` | 2026-09-08T13:14:00Z |
