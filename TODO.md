...
| `LATTICE-equal-rank-indefinite-embeddings-20260908-1145` | arithmetic / equal-rank indefinite embedding witnesses | Chat continuation 2026-09-08; `/home/dzack/research` | `src/dzack_research/preamble/categories/lattice_morphisms.py; tests/lattices/test_equal_rank_indefinite_embeddings.py` (write) | `$(git rev-parse HEAD)` | 2026-09-08T11:45:00Z |
