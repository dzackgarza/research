...
| --- | --- | --- | --- | --- | --- |
| `LATTICE-binary-split-isometry-20260908-1258` | arithmetic / split binary indefinite isometries | Chat continuation 2026-09-08; `/home/dzack/research` | `src/dzack_research/preamble/categories/lattice_morphisms.py; tests/lattices/test_split_binary_indefinite_isometries.py` (write) | `3069ed0c` | 2026-09-08T12:58:00Z |
