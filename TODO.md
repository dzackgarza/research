...
- [ ] **`test-suite-mathematical-assertions`**. **Needs:** none.
  ...
  **Remaining:** the suite outside the protected specifications was rewritten on 2026-09-23 to this standard (1,423 tests in 464 files; 1,519 tests with no mathematical intent removed). The one file left is `tests/test_constructors_meet_their_obligations.py`, the constructor-obligations sweep `AGENTS.md` requires until the owner decides to retire it; it imports engine and internal modules and asserts internal consistency.
