...
- [ ] **`discrete-fixed-mor-universal-constructions`**. **Needs:** none.
...
- [ ] **`architecture-remediation`**. **Needs:** `engine-wiring-audit`, `dual-lattice-through-the-discriminant-sequence`, `discrete-fixed-mor-universal-constructions`, `set-wide-equalizers-and-coequalizers`.
