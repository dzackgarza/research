...
- [ ] **`triage-coproduct-ranking-isomorphism`**. **Needs:** none.
  ...
  **Example:** `tests/sets/test_limits_and_colimits_of_small_diagrams_of_sets.sage::test_the_colimit_over_two_discrete_objects_is_the_disjoint_union`; Tor, which presents a cokernel over a coproduct of generator sets: `tests/modules/test_tor_and_ext_of_finite_cyclic_groups.sage::test_tor_one_of_z6_and_z4_is_z2`.
