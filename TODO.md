...
| --- | --- | --- | --- | --- | --- |
| `ARCHIVE-fractional-ideals-20260908-1840` | archive reconciliation / fractional ideals | Chat continuation 2026-09-08; `/home/dzack/research` | `tests/modules/test_fractional_ideals_archive.py` (write) | `HEAD` | 2026-09-08T18:40:00Z |
