...
| `J1-toric-scheme-assembly-20260908-0150` | J1 / toric scheme assembly and morphisms | Chat continuation 2026-09-08; `/home/dzack/research` | `src/dzack_research/preamble/categories/schemes/toric/toric_schemes.py; src/dzack_research/preamble/categories/schemes/polytopes.py; tests/schemes/test_toric_schemes.py; tests/schemes/test_toric_atlas_gluing.py` (write) | `da28f83c` | 2026-09-08T01:50:00Z |
...
| J | J0 is supplied by existing releases: `86f2b414` constructs degree-zero projective charts and their overlap restrictions from graded localizations; `a24202cd` owns rational fans in a cocharacter lattice with the dual character lattice and perfect evaluation pairing; `dc75fe65`, `46919be9`, and `0026501e` construct cone semigroup algebras, face-localization character maps, and the chart data later used by toric gluing. | J0 is complete. J1 may now reconcile the already-present toric scheme assembly, fan morphisms, polytope polarization, closed-subscheme semantics, and exact standard identifications against G. | J0 released; J1 unclaimed |
