...
| --- | --- | --- | --- | --- | --- |
| `LATTICE-full-orthogonal-transporter-20260908-2000` | arithmetic / full-orthogonal integral transporter | Chat continuation 2026-09-08; `/home/dzack/research` | `src/dzack_research/preamble/categories/rational_integral_stabilizers.py; tests/lattices/test_full_orthogonal_integral_transporter.py` (write) | `0c546b78` | 2026-09-08T20:00:00Z |
