...
- [ ] **`remote-remediation-branches`**. **Needs:** none.
  **Goal:** finish integrating the remaining complaint remediations from `origin/remediate/scheme-gluing`, `origin/remediate/schemes`, `origin/remediate/groups`, `origin/remediate/divisors` and `origin/remediate/functions-sets-tensors` into `main` instead of redoing their work.
