...
| P | `66466ec7`: relative `xy=t`, special fiber, and scalar-preserving successive algebra quotients. `86ed6a99`: free/presented pushout spans. `289d4756`: number-field algebras retain their field engine and chosen primitive presentation. S consumed the represented algebra maps at `7b40b82a`, where affine Spec/FiberProduct maps now preserve owned endpoints. C/P's exact-carrier prerequisite is released at `a3017a8f`. The public ring-side quotient remains an explicit R prerequisite. | The general algebra conversion can now construct multiplication as an equipped structure on the exact supplied module, then implement the general multiplication-preserving Hom and the associative/unital/Lie refinements from the cutoff handoff. Existing represented-family consumers retain their released scope. | Exact C/P prerequisite released: `a3017a8f`; general P conversion unclaimed |
