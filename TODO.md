...
| `ARCHIVE-gram-matrix-graph-20260911-1055` | archive reconciliation / Gram matrix graph and inverse | Chat continuation 2026-09-11; `/home/dzack/research` | `tests/forms/test_gram_matrix_graph_archive.py; computations/reports/archive_reconciliation_inventory.tsv` (write) | `HEAD` | 2026-09-11T10:55:00Z |
