...
| `ARCHIVE-isometry-structure-description-20260909-1143` | archive reconciliation / finite isometry-group structure description | Chat continuation 2026-09-09; `/home/dzack/research` | `src/dzack_research/preamble/categories/lattice_morphisms.py; tests/lattices/test_isometry_structure_description_archive.py` (write) | `HEAD` | 2026-09-09T11:43:00Z |
