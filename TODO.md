...
| `ARCHIVE-framework-scenario-manifest-20260911-1448` | archive reconciliation / retire framework scenario manifest | Chat continuation 2026-09-11; `/home/dzack/research` | `tests/foundations/test_framework_scenario_manifest_archive.py; computations/reports/archive_reconciliation_inventory.tsv` (write) | `HEAD` | 2026-09-11T14:48:00Z |
