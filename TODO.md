...
| `COLLECTION-orthogonal-double-cosets-20260911-0338` | collection-ownership / finite-character double-coset representatives | Chat continuation 2026-09-11; `/home/dzack/research` | `src/dzack_research/preamble/categories/orthogonal_quotients.py; tests/lattices/test_orthogonal_quotient_collections.py` (write) | `HEAD` | 2026-09-11T03:38:00Z |
