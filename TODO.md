...
| N | `fbb2f2e3` adds a notebook SVG view directly on live `ConvexPolygons`; the view derives cyclic screen coordinates from the exact owned vertices and stores no display state back into the mathematical object. Assertions remain unverified under terminal-T policy. | 2D polygon display is complete. 3D polytope views, Coxeter/ADE TikZ and display-hook policy remain optional N work. | Released: `fbb2f2e3`; N polygon view complete |
...
| `N-coxeter-tikz-20260908-0430` | N / live Coxeter TikZ view | Chat continuation 2026-09-08; `/home/dzack/research` | `src/dzack_research/preamble/categories/coxeter_diagrams.py; tests/lattices/test_coxeter.py` (write) | `4f257ca2` | 2026-09-08T04:30:00Z |
