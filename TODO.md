...
| `ARCHIVE-lattice-predicates-20260909-0351` | archive reconciliation / lattice definiteness and isotropy predicates | Chat continuation 2026-09-09; `/home/dzack/research` | `tests/lattices/test_lattice_predicates_archive.py` (write) | `HEAD` | 2026-09-09T03:51:00Z |
| --- | --- | --- | --- | --- | --- |
