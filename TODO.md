...
| `CORE-lattice-parent-category-boundary-20260911-0926` | category-boundaries / owned lattice parent meets for refinements subobjects and biproducts | Chat continuation 2026-09-11; `/home/dzack/research` | `src/dzack_research/preamble/categories/_lattice.py; tests/categories/test_lattice_parent_owned_meets.py` (write) | `HEAD` | 2026-09-11T09:26:00Z |
