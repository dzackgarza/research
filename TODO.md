...
| `ARCHIVE-isotropic-reduction-names-20260909-1816` | archive reconciliation / isotropic quotient entrypoints | Chat continuation 2026-09-09; `/home/dzack/research` | `src/dzack_research/preamble/categories/lattices.py; tests/lattices/test_isotropic_reduction_archive.py` (write) | `HEAD` | 2026-09-09T18:16:00Z |
