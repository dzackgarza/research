...
| --- | --- | --- | --- | --- | --- |
| `ARCHIVE-galois-decomposition-20260908-1850` | archive reconciliation / decomposition inertia Frobenius | Chat continuation 2026-09-08; `/home/dzack/research` | `tests/groups/test_galois_decomposition_archive.py` (write) | `HEAD` | 2026-09-08T18:50:00Z |
