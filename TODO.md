...
| `ARCHIVE-tensor-direct-sum-20260911-1345` | archive reconciliation / lattice tensor and orthogonal direct-sum module | Chat continuation 2026-09-11; `/home/dzack/research` | `tests/lattices/test_tensor_direct_sum_archive.py; computations/reports/archive_reconciliation_inventory.tsv` (write) | `HEAD` | 2026-09-11T13:45:00Z |
