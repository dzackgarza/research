...
| --- | --- | --- | --- | --- | --- |
| `A0-group-scheme-morphisms-20260907-1510` | A0 / actual morphisms of affine group schemes and common-base action compatibility | Current ChatGPT task 2026-09-07; `/home/dzack/research` | `src/dzack_research/preamble/categories/schemes/group_schemes.py; tests/schemes/test_group_scheme_morphisms.py` (write) | `193c9b726276e2bab7375d8a50e47f54126ff83b` | 2026-09-07T15:10:00Z |
| `A0-cyclic-cover-mu-n-20260907-1505` | A0 / cyclic-cover deck action by the actual group scheme `mu_n` | Current ChatGPT task 2026-09-07; `/home/dzack/research` | `src/dzack_research/preamble/categories/schemes/cyclic_covers.py; tests/schemes/test_cyclic_covers.py` (write) | `d3e930f9` | 2026-09-07T15:05:00Z |
