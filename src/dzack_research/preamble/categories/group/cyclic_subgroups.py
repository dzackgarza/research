...
class CyclicSubgroup(Parent):
    ...
    def __init__(self, supergroup, generator) -> None:
        ...
        if generator.parent() is not supergroup:
        ...
        if supergroup in OwnedFiniteGroups() or supergroup in SageFiniteGroups():
    ...
    def is_finite(self):
        ...
        if self.supergroup() in OwnedFiniteGroups() or self.supergroup() in SageFiniteGroups():
            return True
        return Unknown
    ...
    def order(self):
        if self.is_finite() is True:
            return ZZ(len(self._finite_elements()))
        return Unknown
    ...
    def _element_constructor_(self, datum):
        element = datum if getattr(datum, "parent", lambda: None)() is self.supergroup() else self.supergroup()(datum)
