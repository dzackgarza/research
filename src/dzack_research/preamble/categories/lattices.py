...
class Lattices(OwnedCategoryOverBaseRing):
    ...
    class ParentMethods:
        ...
        def is_nondegenerate(self) -> bool:
            ...
            The Gram presentation decides it: by \(\det G\neq 0\) at finite
            rank, and by its pairing rule, or ``Unknown``, at infinite rank.
            """
        ...
        def dual_lattice(self):
            ...
            match self.module_rank().is_finite():
                case False:
                    return Lattices(ring)(self.gram_tensor().dual_gram_on(self.dual_module()))
