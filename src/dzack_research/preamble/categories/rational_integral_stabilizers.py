...
_ABSENCE = (
    ...
    "restriction changes which ring acts and never the underlying map, though "
    "this preamble's scalar-change functor refuses to materialize it without "
    "a framing.  What refuses the mathematics is ModuleMorphism.lift in "
