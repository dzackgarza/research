...
_EXPORTS = {'FunctionModule': ('dzack_research.preamble.categories.modules.pure.function_modules', 'FunctionModule'),
...
__all__ = ['FreeModules', 'FunctionModule', 'FunctionModules', 'Modules', 'ProjectiveModules', 'TorsionModules', 'VectorSpaces', 'smooth_functions', 'square_integrable_functions']
