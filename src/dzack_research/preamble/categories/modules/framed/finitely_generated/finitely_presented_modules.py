        ...
        def subobject_on(self, module_generators):
            ...
            if self.base_ring() in LocalRings():
                ...
                try:
                    ...
                    spans_all = False
            if spans_all:
                image = self._same_presentation_module(self.module_generating_set())
                ...
                inclusion._preamble_lift = lift_from_ambient
                image._preamble_inclusion = inclusion
                return refine(image, ModuleSubobjects(self.base_ring()))
