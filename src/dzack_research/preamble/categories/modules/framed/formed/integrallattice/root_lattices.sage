...
class RootLattices(Category):
    ...
    class ParentMethods:
        ...
        def _Hom_(self: Self, codomain: "FormModule", category: Category | None = None):
            r"""Build root-lattice endsets in the root-lattice arrow category."""
            if category is None and codomain in RootLattices():
...
class RootLatticeIsometries(Category):
    ...
    class ParentMethods:
        ...
        @lazy_attribute
        def _cardinality(self: Self) -> "Cardinal":
