...
class FiniteCoxeterDiagram(CoxeterDiagramParent):
    ...
    * TikZ output omits self-loops and renders edges from the Coxeter
    ...
    def cardinality(self) -> "Cardinal":
        r"""Return the number of vertices of this diagram."""
        return Cardinal(self._index_set.cardinality())
    ...
    def root_morphism(self) -> FormMorphism:
        ...
        return refine(self._root_morphism, ArrowCategory(IntegralLattices()))
