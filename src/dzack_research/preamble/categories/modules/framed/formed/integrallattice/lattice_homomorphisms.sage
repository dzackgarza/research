...
class LatticeHomomorphisms(Category):
    ...
    def super_categories(self) -> list:
        ...
        ``Sets.ElementType`` -- the elements of a *set* -- ahead of
        ``Sets._HomCategory.ElementType`` in the element class.  A morphism
        ...
        return [FormModules(SageZZ).HomCategory()]
    ...
    class ElementMethods:
        def discriminant_isometry(self: "Morphism") -> "Morphism":
            ...
            :meth:`~LatticeIsometries.ElementType.discriminant_morphism`,
...
class IsometryHomsets(Category):
    ...
    class ParentMethods:
        ...
        ``IntegralLattices.ObjectType.is_isometric`` is this homset's
