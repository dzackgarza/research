...
NegativeDefTwoElementary = {
        ...
        (8, 6, 0): [
            (_L := Lattices.A1^8).glue(_L.project_to_discriminant_group(_L.dual_lattice_element((1 / 2, 1 / 2, 1 / 2, 1 / 2, 1 / 2, 1 / 2, 1 / 2, 1 / 2)))),
        ],
        ...
        (9, 7, 1): [
            (_L := Lattices.A1^9).glue(_L.project_to_discriminant_group(_L.dual_lattice_element((0, 1 / 2, 1 / 2, 1 / 2, 1 / 2, 1 / 2, 1 / 2, 1 / 2, 1 / 2)))),
        ...
        (10, 6, 1): [
            ...
            (_L := Lattices.A1^6 + Lattices.D4).glue(_L.project_to_discriminant_group(_L.dual_lattice_element((1 / 2, 1 / 2, 1 / 2, 1 / 2, 1 / 2, 1 / 2, 0, 0, 1 / 2, 1 / 2)))),
            Lattices.D6 + Lattices.A1^4,
        ],
        (10, 8, 1): [
            Lattices.D4 + Lattices.A1^6,  # AE label: D_4 A_1^6*
            (_L := Lattices.A1^10).glue(_L.project_to_discriminant_group(_L.dual_lattice_element((0, 0, 1 / 2, 1 / 2, 1 / 2, 1 / 2, 1 / 2, 1 / 2, 1 / 2, 1 / 2)))),
            (_L := Lattices.A3 + Lattices.E7.twist(2)).glue(_L.project_to_discriminant_group(_L.dual_lattice_element((1 / 2, 0, 1 / 2, 0, 1 / 2, 0, 0, 1 / 2, 0, 1 / 2)))),
        ],
        (11, 3, 1): [
        ...
        (11, 5, 1): [
            ...
            (_L := Lattices.D6 + Lattices.A1^5).glue(_L.project_to_discriminant_group(_L.dual_lattice_element((1 / 2, 0, 1 / 2, 0, 0, 1 / 2, 1 / 2, 1 / 2, 1 / 2, 1 / 2, 1 / 2)))),
        ],
        (11, 7, 1): [
            Lattices.D6 + Lattices.A1^5,
            (_L := Lattices.A1^7 + Lattices.D4).glue(_L.project_to_discriminant_group(_L.dual_lattice_element((0, 1 / 2, 1 / 2, 1 / 2, 1 / 2, 1 / 2, 1 / 2, 0, 0, 1 / 2, 1 / 2)))),
            Lattices.D4^2 + Lattices.A1^3,
            (_L := Lattices.A5 + Lattices.E6.twist(2)).glue(_L.project_to_discriminant_group(_L.dual_lattice_element((1 / 3, 2 / 3, 0, 1 / 3, 2 / 3, 1 / 3, 0, 2 / 3, 0, 1 / 3, 2 / 3)))),
        ],
        (12, 2, 0): [Lattices.E8 + Lattices.D4, Lattices.D12],
        (12, 4, 0): [
            (_L := Lattices.E7 + Lattices.A1^5).glue(_L.project_to_discriminant_group(_L.dual_lattice_element((0, 1 / 2, 0, 0, 1 / 2, 0, 1 / 2, 1 / 2, 1 / 2, 1 / 2, 1 / 2, 1 / 2)))),
            Lattices.D8 + Lattices.D4,
        ],
        (12, 4, 1): [
            (_L := Lattices.D8 + Lattices.A1^4).glue(_L.project_to_discriminant_group(_L.dual_lattice_element((1 / 2, 0, 1 / 2, 0, 1 / 2, 0, 0, 1 / 2, 1 / 2, 1 / 2, 1 / 2, 1 / 2)))),
        ...
        (12, 6, 0): [
            Lattices.D4^3,
            (_L := Lattices.E6 + Lattices.E6.twist(2)).glue(_L.project_to_discriminant_group(_L.dual_lattice_element((1 / 3, 0, 2 / 3, 0, 1 / 3, 2 / 3, 1 / 3, 0, 2 / 3, 0, 1 / 3, 2 / 3)))),
            (_L := Lattices.D6 + Lattices.A1^6).glue(_L.project_to_discriminant_group(_L.dual_lattice_element((0, 0, 0, 0, 1 / 2, 1 / 2, 1 / 2, 1 / 2, 1 / 2, 1 / 2, 1 / 2, 1 / 2)))),
        ],
        (12, 6, 1): [
            (_L := Lattices.D6 + Lattices.A1^6).glue(_L.project_to_discriminant_group(_L.dual_lattice_element((1 / 2, 0, 1 / 2, 0, 0, 1 / 2, 0, 1 / 2, 1 / 2, 1 / 2, 1 / 2, 1 / 2)))),
            Lattices.E7 + Lattices.A1^5,
            (_L := Lattices.D4^2 + Lattices.A1^4).glue(_L.project_to_discriminant_group(_L.dual_lattice_element((0, 0, 1 / 2, 1 / 2, 0, 0, 1 / 2, 1 / 2, 1 / 2, 1 / 2, 1 / 2, 1 / 2)))),
            Lattices.D8 + Lattices.A1^4,
            Lattices.D6 + Lattices.D4 + Lattices.A1^2,
            (_L := Lattices.A7 + Lattices.D5.twist(2)).glue(_L.project_to_discriminant_group(_L.dual_lattice_element((3 / 4, 1 / 2, 1 / 4, 0, 3 / 4, 1 / 2, 1 / 4, 1 / 2, 0, 1 / 2, 1 / 4, 3 / 4)))),
        ],
        (13, 3, 1): [
            Lattices.D12 + Lattices.A1,
            Lattices.E7 + Lattices.D6,
            Lattices.E8 + Lattices.D4 + Lattices.A1,
            (_L := Lattices.D10 + Lattices.A1^3).glue(_L.project_to_discriminant_group(_L.dual_lattice_element((1 / 2, 0, 1 / 2, 0, 1 / 2, 0, 1 / 2, 0, 0, 1 / 2, 1 / 2, 1 / 2, 1 / 2)))),
        ],
        (13, 5, 1): [
            Lattices.D8 + Lattices.D4 + Lattices.A1,
            Lattices.E7 + Lattices.D4 + Lattices.A1^2,
            Lattices.D6^2 + Lattices.A1,
            (_L := Lattices.E7 + Lattices.A1^6).glue(_L.project_to_discriminant_group(_L.dual_lattice_element((0, 1 / 2, 0, 0, 1 / 2, 0, 1 / 2, 0, 1 / 2, 1 / 2, 1 / 2, 1 / 2, 1 / 2)))),
            (_L := Lattices.D6 + Lattices.D4 + Lattices.A1^3).glue(_L.project_to_discriminant_group(_L.dual_lattice_element((1 / 2, 0, 1 / 2, 0, 0, 1 / 2, 0, 0, 1 / 2, 1 / 2, 1 / 2, 1 / 2, 1 / 2)))),
            Lattices.D10 + Lattices.A1^3,
            Lattices.E8 + Lattices.A1^5,
            (_L := Lattices.D8 + Lattices.A1^5).glue(_L.project_to_discriminant_group(_L.dual_lattice_element((1 / 2, 0, 1 / 2, 0, 1 / 2, 0, 0, 1 / 2, 0, 1 / 2, 1 / 2, 1 / 2, 1 / 2)))),
            (_L := Lattices.A9 + Lattices.A4.twist(2)).glue(_L.project_to_discriminant_group(_L.dual_lattice_element((3 / 5, 1 / 5, 4 / 5, 2 / 5, 0, 3 / 5, 1 / 5, 4 / 5, 2 / 5, 1 / 5, 2 / 5, 3 / 5, 4 / 5)))),
        ],
        (14, 2, 1): [
            (_L := Lattices.D12 + Lattices.A1^2).glue(_L.project_to_discriminant_group(_L.dual_lattice_element((1 / 2, 0, 1 / 2, 0, 1 / 2, 0, 1 / 2, 0, 1 / 2, 0, 0, 1 / 2, 1 / 2, 1 / 2)))),
            Lattices.D14,
            Lattices.E8 + Lattices.D6,
            Lattices.E7^2,
        ],
        (14, 4, 1): [
            (_L := Lattices.D6^2 + Lattices.A1^2).glue(_L.project_to_discriminant_group(_L.dual_lattice_element((1 / 2, 0, 1 / 2, 0, 0, 1 / 2, 1 / 2, 0, 1 / 2, 0, 0, 1 / 2, 1 / 2, 1 / 2)))),
            Lattices.E8 + Lattices.D4 + Lattices.A1^2,
            Lattices.E7 + Lattices.D6 + Lattices.A1,
            (_L := Lattices.D10 + Lattices.A1^4).glue(_L.project_to_discriminant_group(_L.dual_lattice_element((1 / 2, 0, 1 / 2, 0, 1 / 2, 0, 1 / 2, 0, 0, 1 / 2, 0, 1 / 2, 1 / 2, 1 / 2)))),
            (_L := Lattices.D8 + Lattices.D4 + Lattices.A1^2).glue(_L.project_to_discriminant_group(_L.dual_lattice_element((1 / 2, 0, 1 / 2, 0, 1 / 2, 0, 0, 1 / 2, 0, 0, 1 / 2, 1 / 2, 1 / 2, 1 / 2)))),
            (_L := Lattices.E7 + Lattices.D4 + Lattices.A1^3).glue(_L.project_to_discriminant_group(_L.dual_lattice_element((0, 1 / 2, 0, 0, 1 / 2, 0, 1 / 2, 0, 0, 1 / 2, 1 / 2, 1 / 2, 1 / 2, 1 / 2)))),
            Lattices.D12 + Lattices.A1^2,
            Lattices.D10 + Lattices.D4,
            Lattices.D8 + Lattices.D6,
            (_L := Lattices.A11 + (Lattices.A2 + Lattices.A1).twist(2)).glue(_L.project_to_discriminant_group(_L.dual_lattice_element((1 / 6, 1 / 3, 1 / 2, 2 / 3, 5 / 6, 0, 1 / 6, 1 / 3, 1 / 2, 2 / 3, 5 / 6, 1 / 3, 2 / 3, 1 / 2)))),
        ],
        (15, 1, 1): [
            Lattices.E8 + Lattices.E7,
            (_L := Lattices.D14 + Lattices.A1).glue(_L.project_to_discriminant_group(_L.dual_lattice_element((1 / 2, 0, 1 / 2, 0, 1 / 2, 0, 1 / 2, 0, 1 / 2, 0, 1 / 2, 0, 0, 1 / 2, 1 / 2)))),
        ],
        (15, 3, 1): [
            ...
            (_L := Lattices.D12 + Lattices.A1^3).glue(_L.project_to_discriminant_group(_L.dual_lattice_element((1 / 2, 0, 1 / 2, 0, 1 / 2, 0, 1 / 2, 0, 1 / 2, 0, 0, 1 / 2, 0, 1 / 2, 1 / 2)))),
            (_L := Lattices.D10 + Lattices.D4 + Lattices.A1).glue(_L.project_to_discriminant_group(_L.dual_lattice_element((1 / 2, 0, 1 / 2, 0, 1 / 2, 0, 1 / 2, 0, 0, 1 / 2, 0, 0, 1 / 2, 1 / 2, 1 / 2)))),
        ...
        (16, 0, 0): [
            Lattices.E8^2,
            (_L := Lattices.D16).glue(_L.project_to_discriminant_group(_L.dual_lattice_element((1 / 2, 0, 1 / 2, 0, 1 / 2, 0, 1 / 2, 0, 1 / 2, 0, 1 / 2, 0, 1 / 2, 0, 0, 1 / 2)))),
        ],
        (16, 2, 0): [
            (_L := Lattices.D8^2).glue(_L.project_to_discriminant_group(_L.dual_lattice_element((1 / 2, 0, 1 / 2, 0, 1 / 2, 0, 0, 1 / 2, 1 / 2, 0, 1 / 2, 0, 1 / 2, 0, 0, 1 / 2)))),
            (_L := Lattices.E7^2 + Lattices.A1^2).glue(_L.project_to_discriminant_group(_L.dual_lattice_element((0, 1 / 2, 0, 0, 1 / 2, 0, 1 / 2, 0, 1 / 2, 0, 0, 1 / 2, 0, 1 / 2, 1 / 2, 1 / 2)))),
            Lattices.E8 + Lattices.D8,
            (_L := Lattices.D12 + Lattices.D4).glue(_L.project_to_discriminant_group(_L.dual_lattice_element((1 / 2, 0, 1 / 2, 0, 1 / 2, 0, 1 / 2, 0, 1 / 2, 0, 0, 1 / 2, 0, 0, 1 / 2, 1 / 2)))),
            Lattices.D16,
            (_L := Lattices.A15 + Lattices.A1.twist(2)).glue(_L.project_to_discriminant_group(_L.dual_lattice_element((3 / 4, 1 / 2, 1 / 4, 0, 3 / 4, 1 / 2, 1 / 4, 0, 3 / 4, 1 / 2, 1 / 4, 0, 3 / 4, 1 / 2, 1 / 4, 1 / 2)))),
        ],
        (16, 2, 1): [
            Lattices.E8 + Lattices.E7 + Lattices.A1,
            (_L := Lattices.D8 + Lattices.E7 + Lattices.A1).glue(_L.project_to_discriminant_group(_L.dual_lattice_element((1 / 2, 0, 1 / 2, 0, 1 / 2, 0, 0, 1 / 2, 0, 1 / 2, 0, 0, 1 / 2, 0, 1 / 2, 1 / 2)))),
        ...
        (17, 1, 1): [
            ...
            (_L := Lattices.D16 + Lattices.A1).glue(_L.project_to_discriminant_group(_L.dual_lattice_element((1 / 2, 0, 1 / 2, 0, 1 / 2, 0, 1 / 2, 0, 1 / 2, 0, 1 / 2, 0, 1 / 2, 0, 0, 1 / 2, 0)))),
            (_L := Lattices.D10 + Lattices.E7).glue(_L.project_to_discriminant_group(_L.dual_lattice_element((1 / 2, 0, 1 / 2, 0, 1 / 2, 0, 1 / 2, 0, 0, 1 / 2, 0, 1 / 2, 0, 0, 1 / 2, 0, 1 / 2)))),
            (_L := Lattices.A17).glue(_L.project_to_discriminant_group(_L.dual_lattice_element((2 / 3, 1 / 3, 0, 2 / 3, 1 / 3, 0, 2 / 3, 1 / 3, 0, 2 / 3, 1 / 3, 0, 2 / 3, 1 / 3, 0, 2 / 3, 1 / 3)))),
        ],
}
