...
def gram() -> Any:
    ...
    return catalogue.Lattices.L_20_2_0.gram_matrix()
...
def ten_frames() -> tuple[dict[str, Any], dict[str, Any], Any]:
    ...
    EXAMPLES::
        ...
        (12, 12, 12)
    """
    matrix_gram = catalogue.Lattices.TEn.gram_matrix().change_ring(QQ)
    size = matrix_gram.ncols()
...
def diagonal_embedding_images() -> dict[str, Any]:
    ...
    expected = catalogue.Lattices.E8_2.gram_matrix().change_ring(QQ)
