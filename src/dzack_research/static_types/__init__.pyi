...
class DifferentialGradedObject[G](GradedObject[G]): ...
...
type DeRhamAlgebra[Ctx] = DifferentialGradedObject[DeRhamGradedTag[Ctx]]
...
def graded_object_view[G](value: object, /) -> GradedObject[G]: ...
...
def differential_graded_object_view[G](
    value: object, /
) -> DifferentialGradedObject[G]: ...
...
def dga_d[G, P: IntVar](
    algebra: DifferentialGradedObject[G],
