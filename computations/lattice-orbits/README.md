...
Related paper notes live under `notes/papers/dawes-2022-orbits-in-lattices/`.
Cross-paper literature findings live under `notes/topics/isotropic-vector-orbits/`.
