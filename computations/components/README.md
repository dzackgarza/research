...
Reusable computational pieces factored out of scratchpad work or named computation threads.
A component should exist because code is reused across computations, not because a mathematical subject deserves a category.
