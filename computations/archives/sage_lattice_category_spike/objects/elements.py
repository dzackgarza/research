...
class SyntheticLatticeElement(LatticeElement, Element):
    ...
    def __init__(self, parent: SyntheticLattice, coordinates: Sequence[Rational] | Vector | SyntheticLatticeElement) -> None:
    ...
    def __mul__(self, other: SyntheticLatticeElement | RingElement) -> SyntheticLatticeElement | Rational:
