...
class Subobject:
    ...
    def is_isometric(self, other: object) -> bool:
    ...
    def sum(self, other: Subobject, label: str = "sum") -> Subobject:
        ...
        return self.ambient()._subobject_from_rows(module.basis_matrix(), label)
    ...
    def orthogonal_complement(self, label: str = "orthogonal_complement") -> Subobject:
        ...
        return ambient._subobject_from_rows(kernel_rows, label)
    ...
    def saturation(self, label: str = "saturation") -> Subobject:
        ...
        return ambient._subobject_from_rows(saturated_rows, label)
...
class LatticeMorphism(lexicon.LatticeMorphism, SageMorphism):
    ...
    def induced_map_on_quotient(self, quotient: LatticeCokernel) -> CategoryMorphism:
        ...
        return quotient.hom([quotient.projection(self(quotient.lift(generator))) for generator in quotient.gens()])
...
class IsometryHomset(lexicon.IsometryHomset, Parent):
    ...
    def an_element(self) -> LatticeMorphism:
        ...
        if self._domain == self._codomain:
            return self._domain.identity_morphism()
        left, right = self._domain, self._codomain
