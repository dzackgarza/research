...
def finite_basis_from_generators(parent: "SageParent", gens: "RawVectors") -> tuple[Any, ...]:
...
class SyntheticDiscriminantGroupElement(Element):
    ...
    def __init__(self, parent: "SageParent", coordinates: "Vector") -> None:
...
class SyntheticDiscriminantSubgroup:
    ...
    def __init__(self, ambient: "Lattice", gens: "RawVectors") -> None:
        from .discriminant_forms import SyntheticDiscriminantForm
