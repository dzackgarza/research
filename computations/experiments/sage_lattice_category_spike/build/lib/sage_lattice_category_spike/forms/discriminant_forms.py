...
class SyntheticDiscriminantForm(FiniteAbelianGroup, DiscriminantElementParent):
    ...
    def subgroup_generated_by(self, gens: "RawVectors") -> "DiscriminantSubgroup":
    ...
    def relations_among(self, gens: "RawVectors") -> "MorphismMatrix":
        return finite_relations_among(self, gens)

    def basis_from_generators(self, gens: "RawVectors") -> tuple[Any, ...]:
...
class SyntheticBilinearDiscriminantForm(BilinearDiscriminantForm, SyntheticDiscriminantForm):
    ...
    def subquotient_form(self, subgroup_or_gens: "DiscriminantSubgroup | RawVectors", quotient_subgroup_or_gens: "DiscriminantSubgroup | RawVectors") -> "DiscriminantForm":
        ...
        assert self.is_isotropic_subgroup(subgroup), "subquotient form requires a quadratic-isotropic relation subgroup"
