...
class IntegralNondegenerateLattice(NondegenerateLattice):
    ...
    @abstract_method
    def embeds_primitively_in_even_unimodular(self, signature_pair: SignaturePair) -> bool: ...

    @abstract_method
    def primitive_embedding_into_even_unimodular(self, signature_pair: SignaturePair) -> LatticeMorphism: ...
