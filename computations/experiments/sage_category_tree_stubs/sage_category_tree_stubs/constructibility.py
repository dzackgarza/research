"""Finite-limit derivability of canonical maps in a typed graph.
    ...
    for _ in range(len(remaining) + 3):
        ...
        for occ_id, req in remaining.items():
            ...
            if req.along is not None:
                ...
                elif req.along == "underlying_module":
                    host_maps = [m for m in host_maps if m.role == "underlying_module" or not m.edges]
        ...
        for occ_id, req, support in enabled:
            ...
            # Add the classifier's total-category leg; keep existing ports.
