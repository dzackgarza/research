...
│   ├── arxiv-2205.10601/                 # Dawes' "Orbits in Lattices" paper
│   │   ├── research_notes.md              # Detailed implementation notes
│   │   └── Computational Techniques...md  # Original research file
│   ├── chicago-paper/                     # O(1,9)(Z) conjugacy classes
│   ├── ut-austin-paper/                   # Maximal integral orthogonal groups
│   └── research_findings.md               # Multi-paper research overview
└── README.md                              # This file
```
...
sage src/isotropic_orbits_proper.sage

# Run examples from the paper
sage src/isotropic_vector_orbits_fixed.sage

# Test isotropic vector computations
sage src/test_isotropic_orbits.sage
```
...
✅ **Working Examples**: Both Example 2.2 and 2.6 from the paper run correctly
✅ **Smith Normal Form**: Orthogonal complement computation working
✅ **Isotropic Detection**: Successfully finds isotropic vectors in U ⊕ A₃
✅ **Signature Computation**: Correctly identifies lattice signatures
