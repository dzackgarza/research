...
Thin facade for the quadratic stratum subordinate to
...
class QuadraticForms(CategoryWithAxiom_over_base_ring):
    r"""Thin facade name for the quadratic refinement of ``ModulesWithForms``."""

    def super_categories(self):
        r"""Return the immediate super categories."""
        return [ModulesWithForms(self.base_ring()).Quadratic()]
