...
class _CoxeterGraph(Protocol):
    ...
    def allow_loops(self, _enabled: bool) -> None: ...
    def vertices(self, _sort: bool = True) -> list[_SageIndex]: ...
    def edges(self, _sort: bool = True, _labels: bool = True) -> list[tuple[_SageIndex, _SageIndex, _SageIndex | str]]: ...
    def relabel(self, _permutation: list[_SageIndex], inplace: bool) -> Self: ...
