...
ARCHIVE_RECONCILIATIONS = (
    ...
    },
    {
        ...
        "owner_overrides": {
            "TensorPower": "src/dzack_research/preamble/categories/modules/powers.py",
            ...
            "divided_square_invariant_inclusion": "src/dzack_research/preamble/categories/modules/powers.py",
            "tensor_square_polarization": "src/dzack_research/preamble/categories/modules/powers.py",
        },
        "disposition": "reconciled-live-owner",
    },
)
