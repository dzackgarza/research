...
def test_target_specific_primitive_embedding_classes_are_actual_maps() -> None:
    ...
    representatives = mor.primitive_embedding_class_representatives("emb")
...
def test_embedding_classification_names_the_equivalence_relation() -> None:
    ...
    sublattice_classes = mor.primitive_embedding_class_representatives("sub")
    embedding_classes = mor.primitive_embedding_class_representatives("emb")
