...
| --- | --- | --- | --- | --- | --- |
| G-finite-scheme-gluing-20260906 | G — glue a finite indexed family of affine charts along distinguished affine pair overlaps, verify inverse/domain compatibility and the triple cocycle, and retain the Stacks maps-out universal property | ChatGPT continuation `2026-09-06-g-finite-scheme-gluing-1042`; `/home/dzack/research` | write: `src/dzack_research/preamble/categories/schemes/gluing.py`; `src/dzack_research/preamble/categories/schemes/schemes.py`; `tests/schemes/test_scheme_gluing.py`; `docs/preamble-megadoc.md`; `docs/preamble-graph.json`; `docs/preamble-graph.dot`; `docs/preamble-graph.html` | `7a63b104`; consumes binary scheme gluing `68c141e5` and existing distinguished-open restriction maps. Supported finite release uses distinguished affine pair overlaps so triple intersections are represented exactly; it will not justify recursive binary Sage gluing as a general finite construction. | 2026-09-06T03:13:48Z |
