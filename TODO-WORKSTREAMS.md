...
| --- | --- | --- | --- |
| C | Interrupted constructor/refinement audit adopted at the current dirty checkpoint; pre-edit megadoc regeneration currently fails in Graphviz rendering. | Isolate and repair the megadoc rendering gate, regenerate/read the artifact, then verify the remaining `refine()` census and constructor semantics before checkpointing. | `C-refine-audit-20260905` |
