...
| A-g-objects-20260905 | A — one category of G-objects in a category C (functors BG -> C, equivariant Hom); finite G-sets and R[G]-modules become its specializations; repair the finite G-set point-set gate | Claude Code session 014pGhSMwfktxgNks1sDaZeo; `/home/dzack/research` | write: `src/dzack_research/preamble/categories/group/g_objects.py`; `src/dzack_research/preamble/categories/group/g_sets.py`; `src/dzack_research/preamble/categories/group/__init__.py`; `src/dzack_research/preamble/categories/modules/group_modules/group_modules.py`; `src/dzack_research/preamble/categories/modules/group_modules/__init__.py`; `src/dzack_research/preamble/categories/functors/g_sets.py`; `src/dzack_research/preamble/categories/functors/group_actions.py`; `src/dzack_research/preamble/all.py`; `tests/groups/test_g_objects.py` | `90a530946c4f22cd325e40eae1fef6f4838f496f` / claimed | 2026-09-05T08:53:14Z |
...
| A | Finite G-set and presented group-module action functors; the finite G-set constructor rejects owned finite ordered sets (it tests Sage's finiteness category). | One owned category of G-objects in C with equivariant Hom; G-sets and R[G]-modules specialize it; repair the point-set gate. | `A-g-objects-20260905` |
