...
| --- | --- | --- | --- | --- | --- |
| G-two-chart-scheme-gluing-20260906 | G — glue two affine schemes along represented affine open immersions, retain the chart/overlap transition data, and realize the Stacks maps-out universal property for compatible scheme morphisms | ChatGPT continuation `2026-09-06-g-two-chart-scheme-gluing-1042`; `/home/dzack/research` | write: `src/dzack_research/preamble/categories/schemes/gluing.py`; `src/dzack_research/preamble/categories/schemes/schemes.py`; `tests/schemes/test_scheme_gluing.py`; `docs/preamble-megadoc.md`; `docs/preamble-graph.json`; `docs/preamble-graph.dot`; `docs/preamble-graph.html` | `ef6b8fa0`; consumes algebra/module descent `bf68bc59`/`9a7cf0d7` and existing affine/open-immersion Homs. Sage provides a genuine binary `GluedScheme` topology carrier but does not verify openness or supply the Stacks mapping property; those are the owned work here. | 2026-09-06T02:52:00Z |
