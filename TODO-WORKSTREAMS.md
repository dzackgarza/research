...
| H-tor-ext-20260905 | H — Tor_n(M, N) and Ext^n(M, N) as cohomology of the tensored and Hom-dualized free resolution, through the existing resolution, tensor, internal-Hom and cohomology owners | Claude Code session 014pGhSMwfktxgNks1sDaZeo; `/home/dzack/research` | write: `src/dzack_research/preamble/categories/modules/derived_functors.py`; `src/dzack_research/preamble/categories/modules/__init__.py`; `src/dzack_research/preamble/all.py`; `tests/modules/test_derived_functors.py` | `31508f25f0d8aa9379ffb37a74badfa2aafe6201` / claimed | 2026-09-05T09:31:21Z |
...
| H | Cohomology of supplied complexes/DGAs in PORT §§8.4, 11, 15. | Tor and Ext of finitely presented modules over a PID from the length-one free resolution; functoriality in the resolved argument (chain-map lifting) and longer resolutions follow. | `H-tor-ext-20260905` |
